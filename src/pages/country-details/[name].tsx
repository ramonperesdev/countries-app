...
import { loadCountryDetails } from '../../store/countries';
...
export default function CountryDetails() {
  ...
  const { countryDetails } = useAppSelector((state) => state.countries);
        ...
        <BoxTextDetails responsive={{ '@bp2': 'desk' }}>
          ...
          <InfoCountry responsive={{ '@bp2': 'desk' }}>
            ...
            <RightSection>
              ...
              <Info>
                <strong>Currencie:</strong> {countryDetails?.currencie?.name}
              </Info>
              <Info>
